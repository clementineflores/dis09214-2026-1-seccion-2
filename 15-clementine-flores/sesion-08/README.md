# sesión 06 - 29/05
# REPASO : ¿Qué es el diagrama de flujo?
...
### Sintáxis -> let nombreArray =[e0 ,e1 ,e2 ,e3 ,e4 ,e5] ;
### Ejemplo -> letColores = ["red", "orange", "yellow", "green", "blue"] ;
...
### Sintáxis  -> se estructura siempre en tres partes dentro de un bloque de llaves:
